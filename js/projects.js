...
// syncProjectsToCloud removed — projects now go direct to Supabase
...
// ============================================================
// PROJECTS — Supabase-backed CRUD with in-memory cache
// getProjects() is synchronous (returns cache)
// All mutations go to Supabase, then reload cache
// ============================================================
...
function saveProjects(projects) {
  ...
  // Async save each modified project to Supabase
...
async function loadProjects() {
  ...
  try {
    // RLS returns own projects + shared projects via SECURITY DEFINER helper
...
async function deleteProjectFromDb(projId) {
  if (!state.sdb) return;
  try {
